        ...
        IEnumerator Start()
        {
            ...
            for (var i = 0; i <= 1000000; i++)
            {
                if (this.BenchmarkType == 0)
                {
                    ...
                    if (i % 1000 == 999) this.m_textMeshPro.fontSharedMaterial = this.m_textMeshPro.fontSharedMaterial == this.m_material01 ? this.m_textMeshPro.fontSharedMaterial = this.m_material02 : this.m_textMeshPro.fontSharedMaterial = this.m_material01;
